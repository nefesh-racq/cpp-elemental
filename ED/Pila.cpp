// ejemplo de una pila, reutilizando la clase lista
// mediante herencia privada
...
*                                                         *
**********************************************************/
// pila derivada de una lista
template <typename TIPOPILA>
class Pila : private Lista<TIPOPILA>
{
public:
	// push llama a la funcion insertarAlFrente de lista
	void push(const TIPOPILA &datos)
	{
		this->insertarAlFrente(datos);
	}

	// pop llama a la funcion eliminarDelFrente de a lista
	bool pop(TIPOPILA &datos)
	{
		return this->eliminarDelFrente(datos);
	}

	// estaPilaVacia llama a la funcion estaVacia de lista
	bool estaPilaVacia() const
	{
		return this->estaVacia();
	}

	// imprimirPila llama a la funcion imprimir de lista
